...
def create_splits(toxic_url, non_toxic_url):
    ...
    toxic_train.to_json("./toxic_train_4k.jsonl", orient="records", lines=True, force_ascii=False)
    toxic_test.to_json("./toxic_test_1k.jsonl", orient="records", lines=True, force_ascii=False)
    ...
    non_toxic_train.to_json("./non_toxic_train_4k.jsonl", orient="records", lines=True, force_ascii=False)
    non_toxic_test.to_json("./non_toxic_test_1k.jsonl", orient="records", lines=True, force_ascii=False)
